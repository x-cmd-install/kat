...
Total: **22,777** lines of code across **126** files in the top 5 languages.
...
- **Upstream**: <https://github.com/MacroPower/kat>
- **License**: Apache-2.0
...
- **Stars**: 167 · **Forks**: 1 · **Open issues**: 24 · **Contributors**: 1

## Totals (cumulative)

- **Releases**: 49 · **Merged PRs**: 271 · **Open PRs**: 33 · **Closed issues**: 19 · **Open issues**: 5 · **Commits**: 621
...
Reported by **2** distros on [repology.org](https://repology.org/project/kat). **1** are ✅ on the latest upstream release, **1** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T20:25:19Z._
